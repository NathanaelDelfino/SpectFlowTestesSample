...
Cenário: Somando dois numeros
	...
	Quando solicitar a soma dos numeros
	Então o resultado esperado é 120
...
Cenário: Subtraindo dois numeros
	...
	Então o resultado esperado é 20
...
Cenário: Multiplicando Dois Numeros
	...
	Então  o resultado esperado é 35
...
Cenário: Dividindo Dois Numeros
	...
	Então o resultado esperado é 5

Cenário: Somando três numeros
	Dado que o primeiro numero é 10
	E que o segundo numero é 20
	E que o terceiro numero 30
	Quando solicitar a soma dos numeros
	Então o resultado esperado é 60
